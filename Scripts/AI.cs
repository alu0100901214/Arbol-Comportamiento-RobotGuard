...
public class AI : MonoBehaviour
{
    ...
    {
        Vector3 dest = new Vector3(Random.Range(-100, 100), 0.5f, Random.Range(-100, 100));
    ...
    // Comportamiento para que el NPC regrese a la última posición donde vió al jugador antes de huir.
